...
parameterinställningar. För varje parameterinställning gjordes tio
körningar och därefter räknades medelvärde och standardavvikelse ut.
...
Elitism-procedur (XXX källa paper?) för att låta en del av de bästa
...
tänka sig fram till en lösning. %??? Vad är skillnad på denna fråga
                                %och nedan?
